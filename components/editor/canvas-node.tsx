...
export function CanvasNodeRenderer({ id, data, selected }: NodeProps<CanvasNode>) {
  ...
  return (
    <div className="group relative h-full w-full">
      ...
      <Handle id="top" type="target" position={Position.Top} className="bg-white! border-zinc-600! opacity-0! transition-opacity! group-hover:opacity-100!" />
      ...
      <Handle id="left" type="target" position={Position.Left} className="bg-white! border-zinc-600! opacity-0! transition-opacity! group-hover:opacity-100!" />
    </div>
  );
}
